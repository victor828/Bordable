...
export default function Table({ title, id, children, height }) {
  ...
  const handleCreate = async (event) => {
    ...
    try {
      ...
      // TODO: hacer recarga de la pagina una vez se precione el boton de envio
  ...
  // console.log(title);
  // console.log(dataEx);
  // const height = cards && cards.length < 1 ? "h-auto" : "h-full";
  // console.log(height);
  return (
    <div className='grid'>
      <section
        ...
        <form className='flex w-full gap-1 box-content'>
        ...
        {/* <article
          ...
          className='w-20 rounded-md bg-[tomato]'>
          {/* content *
          <section>
